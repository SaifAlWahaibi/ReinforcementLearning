...
<br>&nbsp; &nbsp; &nbsp; &nbsp; Execute action $a_t$ in environment and observe $r_t$, $s_t$ and terminal and truncate flags
<br>&nbsp; &nbsp; &nbsp; &nbsp; Set TD target $\delta_T{D} = r_t$ if terminal or truncate flags, otherwise
